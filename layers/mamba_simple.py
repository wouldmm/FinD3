...
class Mamba(nn.Module):
    ...
    def forward(self, hidden_states, inference_params=None):
        ...
        """
        batch, num_node, seqlen, dim = hidden_states.shape
        ...
        xz = rearrange(
            self.in_proj.weight @ rearrange(hidden_states, "b n l d -> d (b n l)"),
            "d (b n l) -> b n d l", b=batch, n=num_node, l=seqlen,
        )
        if self.in_proj.bias is not None:
            xz = xz + rearrange(self.in_proj.bias.to(dtype=xz.dtype), "d -> 1 1 d 1")
